...
const sequelize = new Sequelize('postgres://postgres:postgres@localhost:5432/arosaje', {
    dialect: 'postgres',
    logging: false,
});
...
async function initializeDb() {
    try {
        ...
        // Include any model definitions and relationships here
        await sequelize.sync(); // Optionally synchronize models
